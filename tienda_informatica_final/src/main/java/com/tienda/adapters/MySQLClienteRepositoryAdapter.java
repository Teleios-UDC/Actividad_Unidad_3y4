...
//Adaptador de Salida : Implementa la lógica JDBC para el flujo de Cliente.
...
public class MySQLClienteRepositoryAdapter implements ClienteRepositoryPort {
    ...
    private static final String SQL_SELECT_CLIENTE_BY_ID = 
        "SELECT c.idCLIENTE, c.Nombre, c.Apellido, d.IdDIRECCION, d.Ciudad, d.Barrio, d.Calle, t.idTelefono, t.Telefono, t.TipoTelefono " +
        "FROM CLIENTE c " +
    ...
    public int save(Cliente cliente) {
        ...
        try {
            ...
            try (PreparedStatement ps = conn.prepareStatement(SQL_INSERT_TELEFONO, Statement.RETURN_GENERATED_KEYS)) {
                ps.setInt(1, cliente.getTelefono().getTelefono());
    ...
    public List<Cliente> findAll() {
        ...
        String SQL_SELECT_ALL = SQL_SELECT_CLIENTE_BY_ID.replace("WHERE c.idCLIENTE = ?", "");
    ...
    // MÉTODO UPDATE para Cliente, Dirección y Teléfono)
    ...
    public boolean update(Cliente cliente) {
        ...
        try {
            ...
            //se actualiza CLIENTE, DIRECCION y TELEFONO
